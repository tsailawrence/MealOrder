...
export const CardPriceComponent: React.FC<CardPriceProps> = ({
  amount,
  storeId,
  restaurantName,
  uri,
  ...
  const handleAdd = () => {
    if (itemQuantity < amount) setitemQuantity(itemQuantity + 1);
  };
  ...
  return (
    <Dialog>
      <DialogTrigger className="flex flex-col items-center w-[95%] max-w-xs bg-white rounded-2xl overflow-hidden shadow-lg ">
        <div className="flex flex-col items-center w-full max-w-xs bg-white rounded-2xl overflow-hidden shadow-lg max-md:w-full">
          ...
          <div className="px-4 py-5 w-full">
            ...
            <div className="flex items-center justify-between mt-3">
              <span className="text-red-600 text-xl">NT ${price}</span>
            </div>
          </div>
        </div>
      </DialogTrigger>
      <DialogContent className="overflow-auto max-h-[90vh]">
        ...
        <DialogHeader>
          ...
          <div className="text-neutral-400 text-end">
            Remain Amount : {amount}
          </div>
          <div className="text-neutral-400 text-end">
            Total Cost : {totalcost + price * itemQuantity}
          </div>
        </DialogHeader>
        <DialogFooter>
          <Button
